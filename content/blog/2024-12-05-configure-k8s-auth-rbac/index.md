...
url: /blog/configure-k8s-auth-rbac
coverCaption: "Photo by Growtika on Unsplash"
---
...
![kubernetes-dashboard](images/img-screenshot-k8s-dashboard.png)
...
![screenshot-k8s-dashboard-login](images/img-screenshot-k8s-dashboard-login.png)

Then, you will see *system:serviceaccount:kube-system:charlie* service account as a logged-in user in the profile.

![screenshot-user-charlie](images/img-screenshot-k8s-user-charlie.png)
...
![screenshot-k8s-kubeconfig](images/img-screenshot-k8s-kubeconfig.png)
